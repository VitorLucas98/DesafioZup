...
public class EnderecoResource {
	...
	@GetMapping
	public ResponseEntity<Page<EnderecoDTO>> findAllPaged(@RequestParam(value = "page", defaultValue = "0") Integer page,
	...
	@PutMapping(value = "/{id}")
	public ResponseEntity<EnderecoDTO> update(@RequestBody @Valid EnderecoDTO dto, @PathVariable Long id){
